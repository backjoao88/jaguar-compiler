 ...
 * 
 * @version Fri Mar 29 16:28:57 BRT 2019
 */
...
class CUP$parser$actions {
	...
	public final java_cup.runtime.Symbol CUP$parser$do_action(int CUP$parser$act_num,
		...
		case 4: // EXP_SUB ::= CONSTANTE EXP_SUB_OPERADOR
		{
			...
			Integer constante = Integer.parseInt(
					(String) ((java_cup.runtime.Symbol) CUP$parser$stack.elementAt(CUP$parser$top - 1)).value);
			...
			RESULT = new ExpSub(constante.intValue(), exp_sub_operador);
			String lex = String.valueOf(constante);
			SymST symST = new SymST(lex, sym.CONSTANTE);
			symbolTable.adicionarSimbolo(lex, symST);
		...
		case 1: // $START ::= EXP_SOMA EOF
		{
			...
			symbolTable.mostrarTabelaSimbolos();
			/* ACCEPT */
